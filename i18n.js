...
const KairosI18n = {
  vi: {
    ...
    synFoulT: 'CHẠM SỚM', synFoulS: 'Uống 1 shot. Chạm bên dưới để xác nhận bạn vẫn còn tỉnh.',
  ...
  en: {
    ...
    synFoulT: 'FOUL START', synFoulS: 'Take 1 shot. Tap below to confirm you are still conscious.',
